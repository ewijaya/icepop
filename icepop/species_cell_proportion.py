...
def normalize_tables(exp_pheno_df, cellpop_pheno_name_table_df):
    """
    Expression normalization routines
    """
...
def get_pheno_prop_immgen():
    ...
    """
    exp_pheno_df, cellpop_pheno_name_table_df = ir.read_immgen_hdf_pheno()
    cellpop_pheno_df, cellpop_pheno_name_table_df = normalize_tables(exp_pheno_df, cellpop_pheno_name_table_df)
    return cellpop_pheno_df, cellpop_pheno_name_table_df

def get_pheno_prop_iris():
    """
    Similar with the output generated by scp.get_prop().
    It returns cell type proportion, but at phenotype level.
    Also returns a table that list the phenotype correspondence
    ...
    """
    exp_pheno_df, cellpop_pheno_name_table_df = ir.read_iris_hdf_pheno()
    cellpop_pheno_df, cellpop_pheno_name_table_df = normalize_tables(exp_pheno_df, cellpop_pheno_name_table_df)
    return cellpop_pheno_df, cellpop_pheno_name_table_df
